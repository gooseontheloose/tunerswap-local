...
import { StripeConnectPlugin, stripeConnectPaymentHandler } from './plugins/stripe-connect';
...
export const config: VendureConfig = {
    ...
    paymentOptions: {
        paymentMethodHandlers: [stripeConnectPaymentHandler, dummyPaymentHandler],
    },
    ...
    shippingOptions: {
        ...
        shippingEligibilityCheckers: [defaultShippingEligibilityChecker, tunerSwapShippingEligibilityChecker],
    },
    ...
    plugins: [
        ...
        // Stripe Connect plugin for payment processing and commissions
        StripeConnectPlugin.init({
            defaultCommissionRate: 0.10, // 10% default
