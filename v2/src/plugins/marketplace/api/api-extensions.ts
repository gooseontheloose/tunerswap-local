...
export const shopApiExtensions = gql`
    ...
    "Order for buyer dashboard with seller info"
    type BuyerOrder {
        id: ID!
        code: String!
    ...
    "Paginated list of buyer orders"
    type BuyerOrderList {
        items: [BuyerOrder!]!
        totalItems: Int!
    }
    ...
    "Seller info for invoices (simplified)"
    type InvoiceSeller {
        id: ID!
        name: String!
        businessName: String
    ...
    "Result for invoice payment processing"
    ...
    extend type Query {
        ...
        myBuyerOrders(status: String, skip: Int, take: Int): BuyerOrderList!
    }
    ...
    extend type Mutation {
        ...
        processInvoicePayment(token: String!): InvoicePaymentResult!
